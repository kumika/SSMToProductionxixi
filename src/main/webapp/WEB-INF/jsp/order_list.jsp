...
<%--
<script language="javascript" type="text/javascript" src="<%=basePath %>resources/js/editor/kindeditor.js"></script>

<script charset="utf-8" src="<%=basePath %>resources/js/editor/lang/zh_CN.js"></script>--%>
...
/*
    ...
    KindEditor.ready(function(K){
        editor1 = K.create("textarea[id='content']",{
            ...
            uploadJson:'<%=basePath %>resources/js/editor/jsp/upload_json.jsp', //上传图片的java代码，只不过放在jsp中
            fileManagerJson:'<%=basePath %>resources/js/editor/jsp/file_manager_json.jsp',
