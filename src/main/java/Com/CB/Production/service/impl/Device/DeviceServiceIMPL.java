...
import Com.CB.Production.Mapper.DeviceMapper;
...
import Com.CB.Production.service.DeviceService;
...
public class DeviceServiceIMPL implements DeviceService {
    ...
    public EUDataGridResult getList(Integer page, Integer rows, Device device) {
        ...
        List<Device> deviceList = deviceMapper.find(device);

        EUDataGridResult euDataGridResult = new EUDataGridResult();
        euDataGridResult.setRows(deviceList);
