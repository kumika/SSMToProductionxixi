package Com.CB.Production.controller.quality;
...
public class PMeasureCheckController {
    ...
    @ResponseBody
    private CustomResult insert(@Valid ProcessMmeasureCheck processMeasureCheck, BindingResult bindingResult)
            throws Exception {
        CustomResult result;
    ...
    @ResponseBody
    private CustomResult updateAll(@Valid ProcessMmeasureCheck processMeasureCheck, BindingResult bindingResult)
            throws Exception {
        if(bindingResult.hasErrors()){
            FieldError fieldError = bindingResult.getFieldError();
            return CustomResult.build(100, fieldError.getDefaultMessage());
    ...
    @ResponseBody
    private CustomResult updateNote(@Valid ProcessMmeasureCheck processMeasureCheck, BindingResult bindingResult)
            throws Exception {
        if(bindingResult.hasErrors()){
            FieldError fieldError = bindingResult.getFieldError();
            return CustomResult.build(100, fieldError.getDefaultMessage());
